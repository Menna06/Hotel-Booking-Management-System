...
namespace Hotel_Booking_Management_System.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoomNumber,Type,Price,IsAvailable")] Room room)
        {
        ...
        public IActionResult Search(string searchTerm)
        {
            ...
            {
                rooms = rooms.Where(r => r.Type.Contains(searchTerm));
            }

            return PartialView("_RoomTable", rooms.ToList());
        }
    }
}
